...
Prepared as a competition-ready product blueprint. **Version 1.2 — August 2026.** Supersedes v1.1; renamed from "Is This Real?" to **Provenance**. "Is This Real?" is retained only as the spoken demo hook line (Section 10) — it is no longer the product name. No content changes beyond the rename; all figures, assumptions, and open items from v1.1 carry forward unchanged.
...
| User | What they currently do (manually, if at all) | What Provenance gives them |
|---|---|---|
...
```
┌─────────────────────────────────────────────────────────────────┐
│  PROVENANCE             [Network Map] [Timeline] [Alerts] [Admin]│
├─────────────────────────────────────────────────────────────────┤
│  ┌───────────────────────────────────────┐  ┌──────────────────┐│
│  │                                         │  │ STATION DETAIL   ││
│  │        (o) green = trust > 0.85        │  │ ────────────────││
