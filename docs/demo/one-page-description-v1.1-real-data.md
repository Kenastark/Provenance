# Provenance — AI Trust Layer for Environmental Data (one page, v1.1)

**Track 2B · DEIK.AI Challenge 2026 · Spoken hook: "Is This Real?"**

Version 1.1. **Supersedes `one-page-description-v1.0.md`** (untouched, per standing rule
10). Changed: the completeness figure (~~~99.95%~~ → **100.00% conventional**, measured;
99.95% was the synthetic corpus's grid completeness) and the addition of measured
defect-rate figures throughout. Derivation: `docs/updates/u22-headline-reconciliation.md`.
